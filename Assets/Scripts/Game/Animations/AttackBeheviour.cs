...
public class AttackBeheviour : StateMachineBehaviour
{
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.GetComponent<Character>().HitCollider.enabled = false;
        animator.GetComponent<Character>().SwordCollider.enabled = false;
        animator.GetComponent<Character>().HSlayerCollider.enabled = false;
        if (animator.tag == "swordAttack")
        {
            animator.ResetTrigger("swordAttack");
        }
        else if (animator.tag == "hSlayerAttack")
        {
            animator.ResetTrigger("hSlayerAttack");
        }
